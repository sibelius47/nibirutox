...
exports.MsgClientImpl = exports.MsgSwapAssetsResponse = exports.MsgSwapAssets = exports.MsgExitPoolResponse = exports.MsgExitPool = exports.MsgJoinPoolResponse = exports.MsgJoinPool = exports.MsgCreatePoolResponse = exports.MsgCreatePool = exports.protobufPackage = void 0;
/* eslint-disable */
    ...
    fromPartial(object) {
        ...
        message.poolParams =
            object.poolParams !== undefined && object.poolParams !== null
                ...
                : undefined;
        message.poolAssets = ((_b = object.poolAssets) === null || _b === void 0 ? void 0 : _b.map((e) => pool_1.PoolAsset.fromPartial(e))) || [];
        return message;
    },
};
...
function createBaseMsgSwapAssets() {
    return { sender: "", poolId: long_1.default.UZERO, tokenIn: undefined, tokenOutDenom: "" };
}
...
class MsgClientImpl {
    ...
    JoinPool(request) {
        ...
        return promise.then((data) => exports.MsgJoinPoolResponse.decode(new _m0.Reader(data)));
    }
    ExitPool(request) {
        const data = exports.MsgExitPool.encode(request).finish();
        const promise = this.rpc.request("nibiru.spot.v1.Msg", "ExitPool", data);
        return promise.then((data) => exports.MsgExitPoolResponse.decode(new _m0.Reader(data)));
    }
    SwapAssets(request) {
        const data = exports.MsgSwapAssets.encode(request).finish();
        const promise = this.rpc.request("nibiru.spot.v1.Msg", "SwapAssets", data);
        return promise.then((data) => exports.MsgSwapAssetsResponse.decode(new _m0.Reader(data)));
    }
}
