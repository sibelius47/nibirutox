...
exports.MsgClientImpl = exports.MsgBuybackResponse = exports.MsgBuyback = exports.MsgRecollateralizeResponse = exports.MsgRecollateralize = exports.MsgBurnStableResponse = exports.MsgBurnStable = exports.MsgMintStableResponse = exports.MsgMintStable = exports.protobufPackage = void 0;
/* eslint-disable */
...
class MsgClientImpl {
    ...
    MintStable(request) {
        ...
        return promise.then((data) => exports.MsgMintStableResponse.decode(new _m0.Reader(data)));
    }
    BurnStable(request) {
        ...
        return promise.then((data) => exports.MsgBurnStableResponse.decode(new _m0.Reader(data)));
    }
    Recollateralize(request) {
        ...
        return promise.then((data) => exports.MsgRecollateralizeResponse.decode(new _m0.Reader(data)));
    }
    Buyback(request) {
        const data = exports.MsgBuyback.encode(request).finish();
        const promise = this.rpc.request("nibiru.stablecoin.v1.Msg", "Buyback", data);
        return promise.then((data) => exports.MsgBuybackResponse.decode(new _m0.Reader(data)));
    }
}
