...
exports.Rewards = exports.DatedPrice = exports.ExchangeRateTuple = exports.AggregateExchangeRateVote = exports.AggregateExchangeRatePrevote = exports.Params = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseParams() {
    return {
        ...
        validatorFeeRatio: "",
        expirationBlocks: long_1.default.UZERO,
    };
}
exports.Params = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 11:
                    ...
                    message.expirationBlocks = reader.uint64();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            expirationBlocks: isSet(object.expirationBlocks)
                ? long_1.default.fromValue(object.expirationBlocks)
                : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        ...
        message.expirationBlocks !== undefined &&
            (obj.expirationBlocks = (message.expirationBlocks || long_1.default.UZERO).toString());
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.minVoters =
            object.minVoters !== undefined && object.minVoters !== null
                ? long_1.default.fromValue(object.minVoters)
                : long_1.default.UZERO;
        message.validatorFeeRatio = (_f = object.validatorFeeRatio) !== null && _f !== void 0 ? _f : "";
...
exports.AggregateExchangeRatePrevote = {
    ...
    create(base) {
        return exports.AggregateExchangeRatePrevote.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseAggregateExchangeRatePrevote();
...
exports.AggregateExchangeRateVote = {
    ...
    create(base) {
        return exports.AggregateExchangeRateVote.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseAggregateExchangeRateVote();
...
exports.ExchangeRateTuple = {
    ...
    create(base) {
        return exports.ExchangeRateTuple.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseExchangeRateTuple();
...
function createBaseDatedPrice() {
    return { exchangeRate: "", createdBlock: long_1.default.UZERO };
}
exports.DatedPrice = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.exchangeRate !== "") {
    ...
    fromJSON(object) {
        return {
            ...
            createdBlock: isSet(object.createdBlock)
                ? long_1.default.fromValue(object.createdBlock)
                : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        ...
        message.createdBlock !== undefined &&
            (obj.createdBlock = (message.createdBlock || long_1.default.UZERO).toString());
        return obj;
    },
    create(base) {
        return exports.DatedPrice.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseDatedPrice();
...
function createBaseRewards() {
    return { id: long_1.default.UZERO, votePeriods: long_1.default.UZERO, coins: [] };
}
exports.Rewards = {
    encode(message, writer = minimal_1.default.Writer.create()) {
