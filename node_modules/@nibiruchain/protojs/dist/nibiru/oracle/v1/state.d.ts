...
export declare const PriceSnapshot: {
    ...
    } & { [K_1 in Exclude<keyof I, keyof PriceSnapshot>]: never; }>(base?: I | undefined): PriceSnapshot;
    ...
    } & { [K_3 in Exclude<keyof I_1, keyof PriceSnapshot>]: never; }>(object: I_1): PriceSnapshot;
};
